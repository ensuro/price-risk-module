...
contract AAVERepayPayoutStrategy is PayoutStrategyBase {
  ...
  constructor(IPolicyPool policyPool_, IPool aave_) PayoutStrategyBase(policyPool_) {
    require(
    ...
    require(
      ...
      "AAVERepayPayoutStrategy: the protocol currency isn't supported in AAVE"
    );
  }
